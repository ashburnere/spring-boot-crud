...
public class BookControllerIT {
	...
	public void deletingKnownEntityShouldReturn404AfterDeletion() {
		...
		ResponseEntity<JsonNode> firstResult = this.testRestTemplate.getForEntity(baseUrl + "/api/books/" + bookId,
				JsonNode.class);
		...
		ResponseEntity<JsonNode> secondResult = this.testRestTemplate.getForEntity(baseUrl + "/api/books/" + bookId,
				JsonNode.class);
